...
from Blockchain.utillty import choose_opened_port
from Blockchain.Keys import KeysRSA
...
def mine():
    ...
    blockchain.new_transaction(sender='0', recipient=node_address, amount=1, signature='')
